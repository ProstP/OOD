...
void Menu::Menu::AddItem(const std::string& shortcut, const std::string& description, std::function<void(std::istream&)> command)
{
...
void Menu::Menu::ShowInstructions()
{
	std::cout << std::endl
			  << "Commands:" << std::endl;
...
void Menu::Menu::ExecuteCommand(const std::string& command)
{
